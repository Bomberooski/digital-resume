...
export default function ProjectsPage() {
  const projects = [
      ...
      {name: 'ToDo List', link: 'https://www.seanslife.com', description: 'If my wife has taught me one thing it\'s that I need a ToDo list! You probably do too. So here\'s one for you to try out and use!', videoLink: 'todolist.mov'}
    ]
